...
//    Neo4jRepository neo4jRepository;
    ...
    public Object getPropAll() {
        return nodeService.getSchemaConstraints();
    }

    @GetMapping("/shownodes")
    public List<Object> getTheSchemaNodes() {
        return (List<Object>) nodeRepository.getAllNodes();
    }

    @GetMapping("/showrelationshiptypes")
    public List<Object> getTheSchemaRelTypes() {
        return (List<Object>) nodeRepository.showRelTypes();
    }

    @GetMapping("/showproperties")
    public List<Object> getTheSchemaProperties() {
        return (List<Object>) nodeRepository.getAllProperties();
    }

    @GetMapping("/showrelproperties")
    public List<Object> getTheSchemaRelProperties() {
        return (List<Object>) nodeRepository.getAllRelProperties();
    }

    @GetMapping("/showschema")
    public Result getTheSchema() {
        return nodeService.getSchema();
    }
    ...
    public Object getObjectRel(@PathVariable String keyword) {
        return objectRecognitionService.setParamsAndSearchRel(keyword);
    }
    ...
    public Object getNodeProperties(@PathVariable String node) {
    ...
    public Object getTwoNodesRel(@PathVariable String node1, @PathVariable String node2) {
        return nodeService.getTwoNodesRel(node1, node2);
    }

    @GetMapping("/nodes/value/{node1}/{node2}/{value}")
    public Object getNodesOfValue(@PathVariable String node1, @PathVariable String node2, @PathVariable String value) {
        return nodeService.getNodesOfValue(node1, node2, value);
    }
    ...
    public Object getRelAll(@PathVariable String rel) {
        return nodeService.getRelAll(rel);
    }

    //return all relationships of this type
    @GetMapping("/relationship/nodesinvolved/{rel}")
    public Object getInvolvedNodes(@PathVariable String rel) {
    ...
    public Object getPropCount(@PathVariable String prop) {
        return nodeService.getPropCount(prop);
    }

    //return a property involved nodes
    @GetMapping("/property/nodes/{prop}")
    public Object getPropNodes(@PathVariable String prop) {
        return nodeService.getPropNodes(prop);
    }

    @GetMapping("/property/noderelationships/{prop}")
    public Object getPropNodesRel(@PathVariable String prop) {
        return nodeService.getPropNodesRel(prop);
    }

    @GetMapping("/property/allpropertiesof/{prop}")
    public Object getPropAll(@PathVariable String prop) {
        return nodeService.getPropAll(prop);
    }

    @GetMapping("/property/propertyOfnode/{node}/{prop}")
    public Object getPropOfNode(@PathVariable String prop, @PathVariable String node) {
        return nodeService.getPropOfNode(node, prop);
    }
...
//-------------------- EXPLORE RELATIONSHIP PROPERTIES----------------------------------------------------------------------------------------
    ...
    //count properties
    @GetMapping("/relproperty/count/{prop}")
    public Object getRelPropCount(@PathVariable String prop) {
        return nodeService.getRelPropCount(prop);
    }

    //return a rel property relationships
    @GetMapping("/relproperty/rel/{prop}")
    public Object getRelPropRel(@PathVariable String prop) {
        System.out.println(prop);
        return nodeService.getRelPropRel(prop);
    }
