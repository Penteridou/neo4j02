                            ...
                            keywordTypesArray[index]="nodes";
                             ...
                             return  $.ajax({
                                    ...
                                    success: function(data){
                                        ...
                                        keywordsMap.set((keywordsArray[index]),data);
